...
def main():
    if os.path.exists("C:/Users/korad/OneDrive/Desktop/input.txt"):
        print("File Exists")
        global fi,fo
        fi=open("C:/Users/korad/OneDrive/Desktop/input.txt","r")
        fo=open("C:/Users/korad/OneDrive/Desktop/output.txt","w")   
    else:
